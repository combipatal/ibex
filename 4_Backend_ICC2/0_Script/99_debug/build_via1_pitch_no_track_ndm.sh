...
variant_root="4_Backend_ICC2/2_Output/99_debug/modified_lef_via1_pitch_no_track"
...
log_path="$log_dir/build_via1_pitch_no_track_ndm.log"
...
env \
  ...
  MOD_LEF_WORKSPACE_SUFFIX="ibex_libdir_modify_via1_pitch_no_track" \
  MOD_LEF_NDM_SUFFIX="modified_lef_via1_pitch_no_track" \
  lm_shell -f 4_Backend_ICC2/0_Script/99_debug/build_modified_lef_ndm.tcl \
    | tee "$log_path"

echo "VIA1_PITCH_NO_TRACK_NDM_DONE ndm_dir=$ndm_dir"
